...
|
*/
//$config['base_url'] = 'https://www.jb.com.bd/';

//$config['base_url'] = 'http://172.18.18.71/';

//$config['base_url']  =  ($_SERVER['HTTP_HOST'] == 'www.jb.com.bd' ? 'https' : 'http'). "://".$_SERVER['HTTP_HOST'];
$config['base_url'] = 'http://localhost/jblwebsite/';
