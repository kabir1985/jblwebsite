    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12">
                <h4 style="background: #0099cc;color:#ffffff;padding:6px;"><center> Chairman Message </center></h4>
                <div  style="float:left; padding:0px 10px 0px 0px;">
                    <img style="background: #eef6f9" src="<?php echo base_url(); ?>assets/images/bod/<?php echo $chairImg; ?>" class="rounded-circle" width="100"> 
                </div>
                <p style="margin-bottom: 0px; font-size: 12px;font-weight:bold;"><a href="#" style="text-decoration:none; text-transform:capitalize;">
                        <?php echo $chairName; ?></a>
                </p>
                <span style="color:#000000; font-size: 11px;font-weight: bold;">Chairman</span>
                <br>
                <p id="hiddenChairman" style="text-align:justify;font-size:12px; ">Being the Chairman of the Board of Directors, I am delighted  and  proud  to  have  the  opportunity  to  welcome   respected   shareholders,   customers   and   well-wishers at the 13th Annual General Meeting of Janata Bank Limited. We would like to express our gratitude    for    your    continuous    support    and    cooperation in all our endeavors. At the same time, its  my  pleasure  to  present  before  you  the  annual  report  for  the  year  2019  along  with  the  audited  financial  statements  and  the  achievements  of  the  bank...<a  id="displayChairman" href="javascript:toggleChairman();" style="cursor:pointer;">READ MORE <i class="fa fa-angle-right" aria-hidden="true"></i> </a></p>
            ...
            <!--MD Message-->
            <div class="col-md-4 col-sm-12">
                <h4 style="background: #0099cc;color:#ffffff;padding:6px;"><center> MD & CEO Message </center></h4>
                <div  style="float:left; padding:0px 10px 0px 0px;">
                    <img style="background: #eef6f9" src="<?php echo base_url(); ?>assets/images/bod/<?php echo $mdImg; ?>" class="rounded-circle" width="100"> 
                </div>
                <p style="margin-bottom: 0px;font-size: 12px;font-weight:bold;"><a href="#" style="text-decoration:none; text-transform:capitalize;"><?php echo $mdName; ?></a></p>
                <span style="color:#000000;font-size: 11px; font-weight: bold;">Managing Director & CEO</span>
                <br>
                <p id="hiddenMD" style="text-align:justify;font-size:12px; ">I feel honored to welcome you all at the 13th Annual General Meeting of Janata Bank Limited. Today I have got the opportunity to present the business performance of our beloved Janata Bank before you. As you know, Janata Bank as a trusted partner of the country's industrial, trade and socio-economic development has been playing a unique role. I do think that it is your unflinching support and inspiration that paved the way for our continuous success and progress....<a  id="displayMD" href="javascript:toggleMD();" style="cursor:pointer;">READ MORE <i class="fa fa-angle-right" aria-hidden="true"></i> </a></p>
              <!-- <p id="hiddenChairman"></p>-->
            ...
            <div class="col-md-4 col-sm-12" style="margin-top: 5px;">          
                <div>
                    ...
                    <small style="text-transform:none;font-size: 14px;color: #0099cc;"> as on 
                        <?php
                        /* $today = date('Y-m-d');
...
<!--<script type="text/javascript">
    $('.readall').click(function () {
        var $this = $(this);
        $this.toggleClass('readall');
        if ($this.hasClass('readall')) {
            $this.text('READ MORE..');
        } else {
            $this.text('CLOSE X');
        }
