                ...
                <div class="col-sm-12 col-md-3 col-lg-3">
                    <div class="form-group row" id="searchBox">
                        <label for="search" class="col-sm-4">Search By <br>
                            <a class="col-sm-4" href="<?php echo base_url(); ?>Circular"><i class="fa fa-refresh"></i></a>
                        </label>
                        <div class="col-sm-8">
                        ...
                        <tbody>
                            <?php foreach ($circular_new as $row) { ?>
                                <tr>
                                    ...
                                    <td style="text-align:center"><a href="<?php echo base_url() . 'Circular/pdfIframeView/' . $row->circular_id; ?>" ><i class="fa fa-eye"></i></a></td>                           
        ...
        <script type="text/javascript">
            $(function () {
                $("#show").click(function (e) {  // passing down the event 
                    ...
                    if (maruf.length > 0) {
                        $.ajax({
                            url: "<?php echo base_url(); ?>Circular/searchBy_no",
                            type: 'POST',
                            cache: false,
        ...
        <script type="text/javascript">
            $(function () {
                $("#circularTitle").click(function (e) {  // passing down the event             
                    $.ajax({
                        url: "<?php echo base_url(); ?>Circular/searchBy_title",
                        type: 'POST',
                        cache: false,
        ...
        <script type="text/javascript">
            $(function () {
                $("#formDept").click(function (e) {  // passing down the event             
                    $.ajax({
                        url: "<?php echo base_url(); ?>Circular/searchBy_dept",
                        type: 'POST',
                        cache: false,
        ...
        <script type="text/javascript">
            $(function () {
                $("#formType").click(function (e) {  // passing down the event             
                    $.ajax({
                        url: "<?php echo base_url(); ?>Circular/searchBy_type",
                        type: 'POST',
                        cache: false,
        ...
        <script type="text/javascript">
            $(function () {
                $("#formDate").click(function (e) {  // passing down the event             
                    $.ajax({
                        url: "<?php echo base_url(); ?>Circular/searchBy_date",
                        type: 'POST',
                        cache: false,
