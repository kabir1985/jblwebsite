        ...
        <table id="dataTable" class="table table-striped table-bordered table-responsive-sm" style="width:100%">
            <thead>
                <tr>
                    ...
                    <th class="centered">Date of Rate</th> 
            ...
            <tr>
                ...
                <td class="text-center">
                    <a target="_blank" href="' . base_url() . 'assets/file/ExchangeRate/' . $row->ex_file_path . '">                       
                        <i class="fa fa-eye" aria-hidden="true"></i>
                    </a>
                </td>
                <td class="text-center">
                    <a href="' . base_url() . 'download/download_exRate/' . $row->ex_id . '">
