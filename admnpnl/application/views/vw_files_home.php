<html>
    ...
    <body>
        ...
        ?>
        <p><?php echo anchor("admin/files/addFile", '<i class="fa fa-plus"></i> Add File', 'class="btn btn-primary"'); ?></p>
        ...
        if (count($files)) {
            ...
            echo "<thead><tr>";
            echo "<th>ID</th><th>PageName</th><th>File Title</th><th>FilePath</th><th>Status</th><th>Actions</th>";
            echo "</tr></thead>";
            foreach ($files as $key => $list) {
                ...
                echo '<td  class="center">' . anchor('admin/files/edit/' . $list['id'], '<i class="icon-edit icon-white"></i> Edit', 'class="btn btn-info"') . ' ' .
                anchor('admin/files/delete/' . $list['id'], '<i class="icon-trash icon-white"></i> Delete', 'class="btn btn-danger"') . '</td>';
                echo "</tr>";
            }
            echo "</table>";
        }
