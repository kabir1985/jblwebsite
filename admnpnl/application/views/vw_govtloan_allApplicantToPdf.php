...
if(isset($applicant_all_list) && !empty($applicant_all_list))
{
?>
        <table width="100%"  style="border-collapse:collapse;border: 0px solid #dddddd;">
          ...
          <tr>
            <td colspan="5" align="center"><span style="font-weight:bold; color:#09F;">All Applicants' List of Government Employees for House Building/ Flat Loan</span></td>
          </tr>
          <tr>
...
<?php
	$c=1; 
	foreach ($applicant_all_list as $key => $list)
	{
...
?>          
		...
		?>
        	<td align="left" valign="top" style="border: 0.5px solid #dddddd;">
            <div style="font-size:12px;"><?php echo "Applied for: "."<span style='font-size:12px; font-weight:bold; color:#C96;'>".$list['loanTypeText']."</span>"; ?></div></br>
		...
		?>
        	<td align="left" valign="top" style="border: 0.5px solid #dddddd;">
            <div style="font-size:12px;"><?php echo "Applied for: "."<span style='font-size:12px; font-weight:bold; color:#939;'>".$list['loanTypeText']."</span>"; ?></div></br>
			<div style="font-size:12px;"><?php echo "Loan Amount: ".$loan_amount; ?></div></br>
            <div style="font-size:12px;"><?php echo "Installment: ".$list['loanPeriod']; ?></div></br>
            <div style="font-size:12px;"><?php echo "Branch Name: ".$list['applied_branch']; ?></div></br>
            <div style="font-size:12px;"><?php echo "Applied Date: ".$list['applicationSubmitDateTime']; ?></div>
