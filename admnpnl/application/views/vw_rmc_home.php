<html>
    ...
    <body>
        ...
        ?>
        <p><?php echo anchor("admin/rmc/addRMC", '<i class="fa fa-plus"></i> Add RMC', 'class="btn btn-primary"'); ?></p>
        <?php
        if (isset($rmc)) {
		  ...
		  <th>Actions</th>";
            ...
            foreach ($rmc as $key => $list) {
                ...
                echo '<td  class="center">' . anchor('admin/rmc/edit/' . $list['id'], '<i class="icon-edit icon-white"></i> Edit', 'class="btn btn-info"') . ' ' .
                anchor('admin/rmc/delete/' . $list['id'], '<i class="icon-trash icon-white"></i> Delete', 'class="btn btn-danger"') . '</td>';
