...
<fieldset>  
    ...
    <p style="margin: -40px 0 10px -22px;"><?php echo anchor("admin/Files", '<i style="font-size:13px;color:red" class="fa fa-angle-double-left"></i> Back', 'class="btn btn-primary"'); ?></p>    
    ...
    echo form_open_multipart('admin/Files/addFile', $attributes);
    ...
    $data = array('name' => 'image', 'id' => 'upload', 'class' => 'formUpload');
    echo form_upload($data) . "</div>";
