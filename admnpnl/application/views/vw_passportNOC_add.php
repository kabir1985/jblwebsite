<fieldset>
    ...
    echo form_open_multipart('admin/passport_noc/addNOC', $attributes);
    ...
    $data = array('name' => 'employeename',
        ...
        'col' => 5,
        'class' => 'formTextArea',
        'value' => (isset($_POST['employeename']) ? $_POST['employeename'] : '' )
    );
    echo form_textarea($data);
    echo '<span style="color:#F00; font-weight:bold; "><div class="errormessage">' . form_error('employeename') . '</div></span></div>';
    ...
    echo "<div class='form-group'><label for='employeefile'>File No.</label></br>";
    $data = array('name' => 'employeefile',
        'id' => 'employeefile',
        'class' => 'formTextArea',
        'value' => (isset($_POST['employeefile']) ? $_POST['employeefile'] : '' )
        //'placeholder' => 'Type only the number'
    );
    echo form_input($data);
    echo '<div class="errormessage" style="color:#F00; font-weight:bold; ">' . form_error('employeefile') . '</div></div>';
    ...
    $data = array('name' => 'employeefathername',
        ...
        'col' => 5,
        'class' => 'formTextArea',
        'value' => (isset($_POST['employeefathername']) ? $_POST['employeefathername'] : '' )
    );
    echo form_textarea($data);
    echo '<div class="errormessage" style="color:#F00; font-weight:bold; ">' . form_error('employeefathername') . '</div></div>';

    echo "<div class='form-group'><label for='title'>Employee's Current Passport No.</label></br>";
    $data = array('name' => 'employeecurrpass',
        'id' => 'employeecurrpass',
        'class' => 'formTextArea',
        'value' => (isset($_POST['employeecurrpass']) ? $_POST['employeecurrpass'] : '' )
    );
    echo form_input($data);
    echo '<div class="errormessage" style="color:#F00; font-weight:bold; ">' . form_error('employeecurrpass') . '</div></div>';
    ...
    $data = array(
        ...
        'class' => 'issuedate',
        'class' => 'formTextArea',
        'value' => (isset($_POST['nocdate']) ? $_POST['nocdate'] : '' )
    );
    echo form_input($data);
    echo '<div class="errormessage" style="color:#F00; font-weight:bold; ">' . form_error('nocdate') . '</div></div>';

    echo "<div class='form-group'><label for='news_date'>NOC Upload Date</label></br>";
    $data = array(
        'name' => 'uploaddate',
        'id' => 'uploaddate',
        'class' => 'uploaddate',
        'readonly' => 'readonly',
        //'type' => 'hidden',
        'value' => (isset($_POST['uploaddate']) ? $_POST['uploaddate'] : date('Y-m-d') )
    );
    echo form_input($data);
    echo '<div class="errormessage" style="color:#F00; font-weight:bold; ">' . form_error('uploaddate') . '</div></div>';
