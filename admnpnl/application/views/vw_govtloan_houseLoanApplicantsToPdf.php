<?php
if (isset($applicant_house_list) && !empty($applicant_house_list)) {
    ?>
    <table width="100%"  style="border-collapse:collapse;border: 0px solid #dddddd;">
        ...
        <tr>
            <td colspan="5" align="center"><span style="font-weight:bold; color:#09F;">House Loan Applicants' List of Government Employees</span></td>
        </tr>
        <tr>
        ...
        <?php
        $c = 1;
        foreach ($applicant_house_list as $key => $list) {
