<span style="margin-top: 0px;"><?php echo anchor("admin/marquee", '<i style="font-size:13px;color:red" class="fa fa-angle-double-left"></i> Back', 'class="btn btn-primary"'); ?></span>
<fieldset>
    ...
    echo form_open_multipart('admin/marquee/addMarquee', $attributes);
    ...
    echo form_dropdown('image', $options) . "</div>";
    ...
    $data = array(
        ...
        'id' => 'endDate',
        'value' => (isset($_POST['expiryDate']) ? $_POST['expiryDate'] : '')
    );
    ...
    echo form_dropdown('priority', $count) . "</div>";
