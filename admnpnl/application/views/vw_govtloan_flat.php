<html>
    ...
    <body>
        <p align="right"><a href="<?php echo base_url(); ?>index.php/admin/govtloan/download_success_pdf_flat">DOWNLOAD LIST OF THE APPLICANTS FOR FLAT LOAN</a></p>
        <?php
        ...
        if (count($govtloan_flat)) {
		  ...
		  <th>Action</th>";
            echo "</tr></thead>";
            foreach ($govtloan_flat as $key => $list) { {
                    $url = base_url();
