...
|
*/
#$config['base_url'] = 'http://172.17.21.30/admnpnl/';
#$config['base_url'] = 'http://103.177.142.103/admnpnl/';
//$config['base_url'] = 'http://172.18.18.71/admnpnl/';
//$config['base_url'] = 'https://'.$_SERVER['HTTP_HOST'].'/admnpnl';

$config['base_url'] = 'http://localhost/admnpnl/';
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
